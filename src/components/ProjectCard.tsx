	...
	return (
		...
		<div className="lg:w-fit md:block lg:flex justify-between group/img lg:mx-3 xl:mx-10 pb-20 xl:pb-24">
			...
			<div className={"cursor:mb-14"}>
				...
				<p className="card-text w-96 mb-10">{props.text}</p>
			...
			<div className={"lg:space-x-10 xl:space-x-16 lg:space-y-0 flex justify-center flex-col cursor:flex-row"}>
				...
				{/*links*/}
					<div className={"z-10 flex absolute translate-y-1/2 cursor:group-hover/img:opacity-100 space-x-12 transition-all opacity-0 delay-75 lg:group-hover/img:translate-x-6 xl:group-hover/img:translate-x-12"}>
						{props.link ?
							<a href={props.link} target={'_blank'} className={"group"}>
								<i className="fa-solid fa-arrow-up-right-from-square
						text-6xl hidden cursor:inline-block  group-hover:text-secondary"></i>
							</a> : null}
						{props.github ?
							<a href={props.github} target={'_blank'} className={"group"}>
